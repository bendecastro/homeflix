...
> acquisition VPN gate), **#10** (VPN fail-closed prove-and-restore), and **#11**
> (torrent acquisition tracer) are implemented in this tree.
> Remaining slices cover optional Usenet and program-level fixture acceptance.
> Disposable-host and private-production live acceptance remain separate.
> **#6–#11 are fixture-accepted only; they are not live production verification.**
