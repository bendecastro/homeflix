...
- **In progress:** [Agent-first core setup](../project/agent-first-core-setup-plan.md),
  ...
  on existing mounted storage. Tasks 1–6 passed spec and quality/safety review; executing
  task 7: API-driven Jellyfin/Radarr/Sonarr/Jellyseerr initialization.
