...
def build_parser() -> argparse.ArgumentParser:
    ...
    backup_subparsers.add_parser("create", help="snapshot CONFIG_ROOT into the configured artifact repository")
    backup_subparsers.add_parser("list", help="list backup artifacts newest first")
