...
- Existing-stack core verification SHALL accept Movies and Shows as the required Jellyfin libraries. Music MAY be absent. Extra unrelated libraries SHALL not fail verification. `(satisfied #16)`
